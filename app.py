...
years_experience = st.number_input("Masukan jumlah tahun bekerja:", min_value=0.0, max_value=10.0 step=0.1)

# Prediksi gaji
if st.button("Prediksi Gaji"):
	gaji = lin_reg_loaded.predict([[years_experience]])
	st.write(f"Gaji seorang setelah bekerja selama {years_experience} tahun adalah Rp{gaji[0]:,.2f})") 
